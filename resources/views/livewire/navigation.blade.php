        ...
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div class="flex flex-shrink-0 items-center">
                    <a href="{{ route('index') }}" class="bg-blue-500 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">
                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('posts.categoria', $categoria)}}" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">#{{ $categoria->nombre }}</a>
                        @endforeach
                    </div>
                </div>
            </div>
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <div class="relative ml-3" x-data="{ open:false}">
                    ...
                    <div x-show="open" x-on:click.away="open=false" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                        ...
                        <a href="{{ route('posts.user') }}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Ver mis posts</a>
                        <a href="{{ route('posts.create') }}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Nuevo posts</a>
            ...
            <div class="flex items-stretch">
                <a href="{{ route('login') }}" class="block px-4 py-2 text-sm text-white rounded-md bg-indigo-600 mx-4" role="menuitem" tabindex="-1" id="user-menu-item-1">Login</a>
                <a href="{{ route('register') }}" class="block px-4 py-2 text-sm text-blue-500 rounded-md border-indigo-500 border-2 bg-transparent" role="menuitem" tabindex="-1" id="user-menu-item-2">Register</a>
            </div>
            @endauth
        </div>

<x-app-layout>
    <div class="bg-white py-10 sm:py-10">
        <div class="mx-auto max-w-7xl px-6 lg:px-8"><!-- esto centra el texto -->
            <h1 class="uppercase font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-2xl dark:text-white">Categoria: {{ $categoria->nombre}}</h1>
